...
public class Bank {
    public static void main(String[] args) {
        ...
        userList.add(new User("user1","9111111101",101,500));
        userList.add(new User("user2","9111111102",102,500));
        userList.add(new User("user3","9111111103",103,500));
        userList.add(new User("user4","9111111104",104,500));
        userList.add(new User("user5","9111111105",105,500));
        userList.add(new User("user6","9111111106",106,500));
        userList.add(new User("user7","9111111107",107,500));
        userList.add(new User("user8","9111111108",108,500));
